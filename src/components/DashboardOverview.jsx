...
export default function DashboardOverview({
  ...
  // ใช้ title/subtitle จาก prop ถ้ามี / ถ้าไม่มีก็ใช้ตาม mode
  const headerTitle =
    title || (mode === "staff" ? "รายงานยอดขาย" : "แดชบอร์ด");
  const headerSub =
    subtitle ||
    (mode === "staff"
  ...
  return (
    <>
      ...
      <div className="dashboard-header">
        <div>
          <h2 className="dash-title">{headerTitle}</h2>
          <span className="dash-sub">{headerSub}</span>
        </div>
